...
namespace ApiWebServer.Controllers.ItemControllers
{
    ...
    [ApiController]
    public class ItemUseCharacterCardController : SessionContoller<ReqItemUseCharacterCard, ResItemUseCharacterCard>
    {
        public ItemUseCharacterCardController(
            ILogger<ItemUseCharacterCardController> logger,
            IConfiguration config, 
            IWebService<ReqItemUseCharacterCard, ResItemUseCharacterCard> webService, 
        ...
        [SwaggerExtend( "선수카드 아이템 사용", typeof(ItemUseCharacterCardPacket) )]
        public NPWebResponse Controller([FromBody] NPWebRequest requestBody )
        {
            ...
            ErrorCode errorCode = CacheManager.PBTable.ItemTable.GetCharacterCard(CHARACTER_OBTAIN_TYPE.OBTAIN_ITEM, reqData.ItemIdx, reqData.UseCount, reqData.SelectTeamIdx, reqData.SelectPosition, accountGameInfo,
