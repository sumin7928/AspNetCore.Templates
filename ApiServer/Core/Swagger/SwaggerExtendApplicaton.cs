            ...
            if (usePages == true)
            {
                app.UseSwagger(options =>
                {
                    options.PreSerializeFilters.Add((swaggerDoc, httpReq) =>
                    {
                        ...
                        {
                            List<string> ipList = configSection.GetSection("PrivateAllowedHosts").Get<List<string>>();
                ...
                SwaggerApiWebPacketDocs.Initialize();
            }
            return app;
        }
